...
class TCN(nn.Module):  # TCN
    def __init__(self, input_channel, output_size, num_channels, kernel_size, dropout, vocab_text_size, seq_leng):  # 输入通道数；输出层大小；TCN卷积层中通道数；卷积核大小；dropout；文本词汇表大小；输入序列长度
